...
let title =  data['title']
  ...
  getid('title', title);
    ...
    for(let i = 0; i<data.length; i++){
        ...
        console.log(data[i]['meanings'][m]['synonyms'])
        console.log(data[i]['meanings'][m]['antonyms'])

        if('synonyms' in data[i]['meanings'][m]){

            if(data[i]['meanings'][m]['synonyms'].length==0){
            //    span+="<br><br> <span> <b>   Synonyms: <br> </b> No Synonyms  </span> <br>" 
               console.log(data[i]['meanings'][m]['synonyms'].length)    
            }else{
                console.log(data[i]['meanings'][m]['synonyms'].length) 
                // console.log(data[i]['meanings'][m]['synonyms'])
